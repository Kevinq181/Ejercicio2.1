                ...
                case 1:
                    ...
                    switch (intSeleccion2) {
                        case 1:
                            ...
                            objRegistroAcademico.agregarPersona(objAlumno);
                            try {
                        ...
                        case 2:
                            ...
                            if (intTipoD == 1) {
                                ...
                                objRegistroAcademico.agregarPersona(objDocenteTitular);
                                try {
                                    File f = new File("Registro.csv");
                                    FileWriter fw;
                                    BufferedWriter bw;
                                ...
                                objRegistroAcademico.agregarPersona(objDocenteAuxilar);
                                try {
                                    File f = new File("Registro.csv");
                                    FileWriter fw;
                                    BufferedWriter bw;
